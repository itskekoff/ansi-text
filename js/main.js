...
copybtn.onclick = () => {
    ...
    navigator.clipboard.writeText(toCopy).then(() => {
        ...
        const funnyCopyMessages = copybtn.innerText = ["Скопировано!", "Двойное копирование!", "Тройное копирование!", "Безумие!", "Доминирование!", "Мегакопирование!", "Неудержимый!!", "Полный улёт!", "Чудовищное копирование!", "БОЖЕСТВЕННО!", "БОЛЕЕ ЧЕМ БОЖЕСТВЕННО!", Array(16).fill(0).reduce(p => p + String.fromCharCode(Math.floor(Math.random() * 65535)),"")];
        ...
        copyTimeout = setTimeout(() => {
            ...
            copybtn.innerText = "Скопировать результат";
        }, 2000)
